...
jonathan = Persona('jonathan', 'morales')
print(jonathan)         # por defecto llama al método __str__
print(f'{jonathan!r}')  # llamamos al método __repr__
print(f'{jonathan}')  # al usar el f en el print por defecto llama al método __format__
